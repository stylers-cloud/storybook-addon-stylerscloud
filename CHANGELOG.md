...
- project setup
- fix: update release to publish to npm (pom@stylers.cloud)
- docs: fix readme code formatting ([@pomali](https://github.com/pomali))
- docs: update readme ([@pomali](https://github.com/pomali))
- feat: add support for project mode ([@pomali](https://github.com/pomali))
- docs: update README.md ([@pomali](https://github.com/pomali))
- fix: update readme ([@pomali](https://github.com/pomali))
- fix: change readme npm -> yarn ([@pomali](https://github.com/pomali))
- fix: update package.json tags ([@pomali](https://github.com/pomali))
...
# v0.0.3 (Mon Jun 13 2022)

#### ⚠️ Pushed to `main`

- project setup
- fix: update readme (pom@stylers.cloud)
- fix: change readme npm -> yarn ([@pomali](https://github.com/pomali))
- fix: update package.json tags ([@pomali](https://github.com/pomali))
- Update README.md ([@pomali](https://github.com/pomali))
- feat: better readme, package metadata ([@pomali](https://github.com/pomali))
